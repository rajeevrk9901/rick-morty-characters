...
const Pagination = ({ info, pageNumber, setPageNumber }) => {
    ...
    return (
        ...
        <ReactPaginate className=' flex flex-wrap gap-4 justify-center pb-28 items-center my-4'
            previousLabel="Prev"
            ...
            nextLabel="Next"
            previousLinkClassName="text-white" nextLinkClassName="text-white" breakLinkClassName="text-white" activeClassName="bg-blue-800 px-2 py-1 rounded-sm" activeLinkClassName="text-white"
